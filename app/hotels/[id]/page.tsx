          ...
          <div>
            ...
            <div className="sticky top-8 bg-zinc-950 border border-red-900 rounded-3xl p-8">
              ...
              <Link
                ...
                className="block mt-8 bg-red-600 text-center py-4 rounded-2xl font-bold hover:bg-red-700"
              >
              ...
              <Link
                href="/"
                className="block mt-4 border border-red-900 text-center py-4 rounded-2xl"
              >
